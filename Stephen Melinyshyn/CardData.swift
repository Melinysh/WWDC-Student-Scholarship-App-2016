...
class CardData: NSObject {
	...
	let images = [ "me1", "me2" , "tapz", "rez", "marketmesh", "meshwurk", "codefest", "wellaware", "wwdc", /*"me2"*/ "wattpad"]
	...
	let descriptions = [
		"Welcome to my WWDC App Submission! I'm a 19 year old Canadian with a passion for computer science. Although I've just completed my first year in Software Engineering at the University of Waterloo, my own curiosity and persistence has driven me to explore and experiment with code over the past few years. Using what I've learned over the past several years, I've taken the last 2 weeks to inform you about what exciting things I've done on Apple's platform, what I'm working on, and what I will be doing in the future!",
