...
class CardData: NSObject {
	...
	let descriptions = [
		...
		"My first iOS app I developed was called Tapz and I made it in 2013. The idea behind it was simple; a game where you tap to remove bouncing balls, but avoid the bombs. The faster you can remove the balls, the better. This app developed my skills in Core Animation, Autolayout, integration with social services to share scores and basic file I/O operations to keep track of highscores. Tapz was a hit among my friends and I. We frequently competed against each other for the highest score. Looking back, Tapz is small enough to integrate directly into this app and you are free to play it below. Try to beat a highscore of 4 balls/second!",
		
		"In 2014, I was switching between a couple of different feed reader clients from the App Store and knew that I wasn't satisfied with any of them. It dawned on me that I could build something like this! I knew it would be quite the challenge, but I knew it could be very rewarding. After 5 months of work, Rez Reader launched in the App Store. Rez Reader was downloaded by users around the world, and, most importantly, I was proud of what I accomplished. Rez utilized numerous technologies, such as UIDynamics, Autolayout, Core Data, and social services integration to provide a superior user experience. You can get a closer look by tapping a screenshot below. Earlier this year, I decided to sunset Rez to work on more exciting things that you can read about in the next few cards...",
		
		"In August 2015, I went to my first hackathon called TechRetreat. TechRetreat was an 8 hour long hackathon for highschoolers or recent highschool graduates. At TechRetreat, my team built an iOS app that created a peer-to-peer local market place where goods and services could be sold to nearby devices. One such service I built into the app was the ability to proxy internet connections between iOS devices! This allowed for the selling of one's native data connection to others from within the app. How did we do this? I built upon Apple's Multipeer Connectivity framework to provide the proxying functionality and device communication protocol while my teammates worked on the presentation and UI. MarketMesh won first place for its technical difficulty, creativity, and usefulness. About a month later, MarketMesh was selected for Y Combinator's Office Hours. The team met with Teespring CEO and YC Fellow Evan Stites-Clayton to discuss MarketMesh's market viability. Evan saw the potential in MarketMesh and encouraged us to continue working on it and to contact him again in the future. In the next few months, we plan on filing an application for MarketMesh to my university's own incubator/accelerator, Velocity, for turning it into a real product. You can watch a 50 second demo with audio below.",
		
		"Meshwurk was created by myself and some friends at Hack The North, a 48-hour hackathon in Waterloo last September. Meshwurk allowed users to seamlessly share contact information to those nearby through a secure and efficient peer-to-peer mesh network. Common use cases of this app could involve quickly obtaining a new friend's contact information, or being able to see who in your contacts was nearby. All of this could be done without an internet connection or any backend servers, a real benefit we believe. Building off my experience with Apple's Multipeer Connectivity framework from MarketMesh, I fully implemented the mesh network backend and contact exchange protocol and utilized the new Contacts framework introduced in iOS 9 while my teammates built the UI and our presentation to the judges. Although we were not winners of the hackathon, we impressed our judges and gained more experience with the latest iOS technologies.",
		...
		"Recently, I've been looking for a new challenge. The WWDC Student Scholarship program is a fantastic opportunity to exercise and learn skills. From the start, I was driven to create a simple, playful user interface. Beautiful stacked cards that dropped down in front of the user was a key idea for me. Behind the scenes, it took a considerable amount of work, dynamically generating the cards and the angles at which they fall (if you reset the card stack, you'll see the cards fall rotated differently each time). It also works on both iPad and iPhone through the use of Autolayout, UIStackViews and smart design. In addition, UIDynamics provide the playful bounce to the cards. The app is entirely written by me; no third party code! It also borrows a few ideas I first developed in Rez Reader, but enhanced significantly. I consider this application a culmination of my best iOS programming to date.",
		
		"WellAware is a current project that I'm partnering with one other person to create. WellAware is a tool to locate and report wellwater conditions in the southern Ontario region. Based on extensive research and data collected by my partner, we are able to determine areas at risk of water contamination. For this project, I am the sole developer of the iOS application while my partner is responsible for visual design, and data cultivation. For the app, I'm leveraging Core Data for storing all risk data and for geospatial lookups, along with MapKit for setting the lookup location and for proving directions to the nearest wellwater testing drop off location. WellAware is still under construction, but we plan to have it completed by the end of the summer with interest from third parties.",
